# Plausible Scenario Tests (PST) — Smartsheet Connector
...
- `connect_smartsheet`: validated contract & error handling
- `list_connections`: validated contract & error handling
- `disconnect_smartsheet`: validated contract & error handling
- `audit_smartsheet_health`: validated contract & error handling
- `list_sheets`: validated contract & error handling
- `get_sheet`: validated contract & error handling
- `create_sheet`: validated contract & error handling
- `delete_sheet`: validated contract & error handling
