"""Panel UI for Smartsheet Connector following UI_INTERFACE_STANDARD.md and AUTH_AND_CREDENTIALS_STANDARD.md."""
    ...
    return ui.Stack(
        ...
        children=[
            ...
            ui.Stack(
                ...
                align="stretch",
                children=[
                    ui.Text("Manage your Smartsheet connections and integrations.", variant="caption"),
                ]
            ),
            ui.Divider(),
            ui.Stack(
                ...
                children=[
                    ui.Button(
                        "Sign in with Smartsheet (OAuth / SSO)",
                        variant="primary",
                        size="sm",
                        icon="login"
                    ),
                                ...
                                children=[
                                    ...
                                    ui.Stack(
                                        ...
                                        children=[
                                            ...
                                            ui.Input(param_name="label", placeholder="e.g. Production Smartsheet"),
                                        ]
                                    ),
                                    ui.Stack(
                                        direction="v",
